  ...
  <div>
    ...
    <div class="relative mt-1 rounded-md shadow-sm">
      <input
          ...
          :class="[
            errors.has(name) || (errorKey && errors.has(errorKey)) ? 'border-red-300 pr-10 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500':'',
            !errors.has(name) && !(errorKey && errors.has(errorKey)) ? 'appearance-none border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-'+ color +'-500 focus:ring-'+ color +'-500':'',
